...
function carregarFuncionariosFiltrados (cargo) {
  const funcionariosFiltrados = bdFuncionarios.filter( funcionario => funcionario.cargo.includes (cargo))
  carregarFuncionarios(funcionariosFiltrados)
  console.log(carregarFuncionarios)
}
...
botaoGerente.onclick = () => carregarFuncionariosFiltrados ('Gerente')
